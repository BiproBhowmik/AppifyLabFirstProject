<template>
  <div>
    ...
    <template v-if="isloaded">
      <div v-for="(post, i) in allPosts" :key="i" class="_card _mar_b20">
        <div class="_card_top_all">
          <div class="_card_top">
            <a href="" class="_card_pic">
              <img
                ...
                title=""
                class="_card_img"
                :src="'http://localhost:3333/uploads/' + post.user.profile_picture "
                
              />
               
              <!-- uploads/profilePictures/0.3760895604435832.jpg -->
            </a>
                ...
                <span class="_card_name_main">
                  ...
                  <div class="_pro_info">
                    ...
                    <div class="_pro_info_top">
                      ...
                      <div class="_pro_info_main">
                        ...
                        <ul class="_pro_info_list">
                          ...
                          <li>
                            <i class="fas fa-briefcase"></i> Whiter at
                            <strong> Home</strong>
                          </li>
                          <li>
                            <i class="fas fa-map-marker"></i> From
                    ...
                    <ul class="_pro_info_buttons">
                      <li>
                        <button class="_2btn _btn_pre _btn_sm">
          ...
          <div class="_card_top_more">
            <Dropdown trigger="click" placement="bottom-end">
              ...
              <DropdownMenu slot="list" v-if="currentUserInfo.id == post.user_id">
                <!-- <DropdownItem
                ...
                > -->
                <DropdownItem
                  ><p @click="postDelete(post, i)" class="_drop_text _drop_pre_icon">
                    <i class="fas fa-trash-alt"></i> Delete Post
                  </p></DropdownItem
                >
                <!-- <DropdownItem
                  ><p class="_drop_text _drop_pre_icon">
                    <i class="fas fa-eye-slash"></i> Turn off Commenting
                  </p></DropdownItem
                >
                <DropdownItem divided
                  ><p class="_drop_text _drop_pre_icon">
                    <i class="fas fa-link"></i> Open post in new tab
                  </p></DropdownItem
                > -->
              </DropdownMenu>
            </Dropdown>
        ...
        <div class="_card_body">
          ...
          >
            <div class="_cardMulti_pic_main" v-for="(postImage, i) in postWisePictures[post.id]"
          :key="i">
              <div class="_cardMulti_pic">
                <img
                  alt=""
                  title=""
                  class="_cardMulti_img"
                  :data-src="'http://localhost:3333/uploads/' + postImage.post_image"
                  :src="'http://localhost:3333/uploads/' + postImage.post_image"
                  lazy="loaded"
                />
              </div>
            </div>
            <!-- <div class="_cardMulti_pic_main _cardMulti_more">
              <div class="_cardMulti_pic">
                <img
                  ...
                  title=""
                  class="_cardMulti_img"
                  data-src="http://localhost:3000/uploads/image_1622964305001.png"
                  src="http://localhost:3000/uploads/image_1622964305001.png"
                  lazy="loaded"
                />
        ...
        <div class="_num_like_all">
          <div class="_num_like_left">
            <p class="_num_like_text _num_like_text_like">
              <!-- <span v-if="likeCount[post.id]='NaN'">{{ (likeCount[post.id] = post.like.length) }} like first</span> -->
              <span>{{ likeCount[post.id] }} like</span>
              <!-- <span>{{ post.id }} id</span> -->
              <span hidden>{{ checkLike }} checkLike</span>
            </p>
          </div>
          <div class="_num_like_right">
            <p class="_num_like_text">{{ commentCount[post.id] }} Comment</p>
          </div>
        </div>

        <div class="_1card_count">
          <ul class="_1card_count_list">
            <li @click="clickLike(post)" class="">
              <!-- React -->
            ...
            <li>
              <div class="_1card_count_pic">
                <svg
                  style="enable-background:new 0 0 512 512; margin-bottom: -5px;"
                  class="_1card_count_img"
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  xmlns:svgjs="http://svgjs.com/svgjs"
          ...
          <div class="_1card_comment_box_input_icon">
            <div class="_1card_comment_box_input">
              <input
                ...
                v-model="commentObj.comment_textArray[post.id]"
                type="text"
        ...
        <div
          v-for="(comment, i) in postWiseComments[post.id]"
          :key="i"
          class="_comment_main"
        >
          ...
          <div class="_comment_details">
              ...
              <div class="_comment_more">
                <Dropdown trigger="click" placement="bottom-end">
                  ...
                  <DropdownMenu slot="list">
                    ...
                    <DropdownItem
                      ><p class="_drop_text">Delete</p></DropdownItem
                    >
                  </DropdownMenu>
                </Dropdown>
              </div>
            ...
            <div class="_comment_reply">
              <div class="_comment_reply_num">
                <ul class="_comment_reply_list">
                  <li class="">
                    <svg
                      style="enable-background:new 0 0 512 512; margin-bottom: 0px;"
                      class="_1card_count_img"
                      xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink"
                      xmlns:svgjs="http://svgjs.com/svgjs"
                  ...
                  <li>
                    <svg
                      style="enable-background:new 0 0 512 512; margin-bottom: -2px;"
                      class="_1card_count_img"
                      xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink"
                      xmlns:svgjs="http://svgjs.com/svgjs"
            ...
            <div class="_reply" keys="rep0">
              <div
                v-for="(reply, i) in commentWiseReply[comment.id]"
                :key="i"
                class="_reply_main"
              >
                <a href="" class="_comment_pic">
                  <img
                    ...
                    title=""
                    class="_comment_img"
                    :src="'http://localhost:3333/uploads/' + reply.user.profile_picture"
                  />
                </a>
                <div class="_comment_details">
                  <div class="_comment_details_top">
              ...
              <div class="_1card_comment_box">
                ...
                <div class="_1card_comment_box_input_icon">
                  <div class="_1card_comment_box_input">
                    <input
                      @keyup.enter="addCommentReply(comment)"
                      v-model="commentReplyObj.replyArray[comment.id]"
                      type="text"
    ...
    <div v-if="isModal" class="_imageModal">
      <div class="_imageModal_main">
        ...
        <div class="_imageModal_left">
          ...
          <p class="_imageModal_errow _next">
...
export default {
  ...
  methods: {
    async clickLike(postObj) {
      let likeInfoObj = {
        user_id: this.currentUserInfo.id,
        post_id: postObj.id
      }
      //this.likeCount[postObj.id] = postObj.like.length
      const res = await this.callApi(
        "post",
        "http://localhost:3333/storeLike",
        likeInfoObj
      );
      if (res.status == 200) {
        ...
        if (res.data) {
          // console.log(this.likeCount[postObj.id])
          this.likeCount[postObj.id]++
          // this.checkLike++;
          // console.log(this.likeCount[postObj.id])
          this.checkLike++
        } else {
    ...
    async postDelete(postObj, index) {
      // console.log(postObj)
      const res = await this.callApi(
        "post",
        "http://localhost:3333/deletePost",
        postObj
      );
      if (res.status == 200) {
    ...
    async addComment(postObj) {
      this.commentObj.post_id = postObj.id;
      this.commentObj.user_id = this.currentUserInfo.id;
      this.commentObj.comment_text = this.commentObj.comment_textArray[
        postObj.id
      ];
      const res = await this.callApi(
        "post",
        "http://localhost:3333/storeComment",
        this.commentObj
      );
      if (res.status == 200) {
        // console.log(res.data)
        this.postWiseComments[postObj.id].push(res.data)
        this.commentObj.comment_textArray.splice(postObj.id, 1);
        this.commentObj.post_id = 0;
        this.commentObj.user_id = 0;
        this.commentCount[postObj.id]++;
        // console.log("Done");
      }
    },
    async addCommentReply(commentObj) {
      // console.log(commentObj)
      this.commentReplyObj.comment_id = commentObj.id;
      this.commentReplyObj.user_id = this.currentUserInfo.id;
      this.commentReplyObj.reply_text = this.commentReplyObj.replyArray[
        commentObj.id
      ];
      console.log(this.commentReplyObj)
      const res = await this.callApi(
        "post",
        "http://localhost:3333/storeCommentReply",
        this.commentReplyObj
      );
      if (res.status == 200) {
        this.commentWiseReply[commentObj.id].push(res.data)
        this.commentReplyObj.replyArray.splice(commentObj.id, 1);
        this.commentReplyObj.reply_text = "";
        this.commentReplyObj.comment_id = 0;
        this.commentReplyObj.user_id = 0;
        // console.log("RDone");
      }
    }
  },
    ...
    axios
      ...
      .then(response => {
        ...
        response.data.forEach(post => {
          this.likeCount[post.id] = post.like.length
          this.commentCount[post.id] = post.comment.length
          this.postWiseComments[post.id] = post.comment
          this.postWisePictures[post.id] = post.postImage
          post.comment.forEach(comment => {
            this.commentWiseReply[comment.id] =  comment.commentReply
            // console.log(this.commentWiseReply[comment.id]);
          });
        });
